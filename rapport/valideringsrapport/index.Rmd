...
Tabell som viser antall og andel av type pumpe som blir brukt. Total pasienter med registerte data er `r nPump`, mens det manger data for `r mispump` pasienter.
