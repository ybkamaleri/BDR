...
```
Antall registrerte pasienter med diabetes (alle typer ) for `r hospTitle` er **`r antall.lokal`** pasienter, mens antall registrerte pasienter i hele landet som har tatt årskontroll i 2018 er **`r antall.nasj`** pasienter.
