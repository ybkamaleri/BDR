...
Insulinpumpe brukes av `r insN` pasienter (`r insPros`%) og `r multN` pasienter (`r multPros`%) bruker multiinjeksjon. Tabell for typer av insulinbehandling nedenfor viser gjennomsnittlig antall enheter per. kg/døgn delt på aldersgrupper. Analysen inkluderes bare de som har data på kroppsvekt og på alle spørsmålene for insulinpumpe og multiinjeksjon. Derfor kan antall pasienter i tabellen være ulik med antall pasienter nevnt ovenfor.
