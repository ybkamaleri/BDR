...
Totalt pasienter som har data på insulinbehandling er `r behNtot`. Av disse bruker`r
insN` pasienter (`r insPros`%) insulinpumper og `r multN` pasienter (`r multPros`%)
bruker multiinjeksjon. Tabellen for type insulinbehandling nedenfor viser
