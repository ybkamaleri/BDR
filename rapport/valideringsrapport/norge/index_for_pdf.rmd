...
- \renewcommand{\contentsname}{BDR Nasjonale tall}
- \usepackage{titling}
...
```{r nasjonal2, warning=FALSE, message=FALSE}
source("./analyseNorge/pas_etnisk.R")
...
```{r pieut2, fig.cap="insulinbehandling", out.extra='', fig.hight=4, fig.width=4}
