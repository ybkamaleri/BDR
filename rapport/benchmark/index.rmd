...
Antall og andel pasienter med HbA1c < 7.0% og HbA1c < 7.5% som har fått insulinsjokk.  **Total N** er antall som har svart til spørsmålet.
...
# Følinger og HbA1c
Antall og andel pasienter med HbA1c < 7.0% og HbA1c < 7.5% som har hatt følinger med behov for hjelp siste 4 uker. **Total N** er antall som har svart til spørsmålet.
...
diabetesvarighet eller yngre enn 10 år med 5 års diabetesvarighet.
...
# Insulinpumpe
Gjennomsnittlig antall enheter insulin pr. døgn (bolus og basal) per. kg kroppsvekt.
...
# Multiinjeksjon (penn)
Gjennomsnittlig antall enheter insulin pr. døgn per. kg kroppsvekt.
