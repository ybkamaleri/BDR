...
NokBF <- norskBF[, .(N = sum(get(nbf), na.rm = TRUE)), keyby = fylke]

## Antall per kjønn
KjonnBF <- norskBF[, .(N = sum(get(nbf), na.rm = TRUE)), keyby = .(kjonn, fylke)]

## Antall per alder
AgeBF <- norskBF[, .(N = sum(get(nbf), na.rm = TRUE)), keyby = .(age, fylke)]

## Antall per alder og kjonn
AgeKjonnBF <- norskBF[, .(N = sum(get(nbf), na.rm = TRUE)), keyby = .(kjonn, age, fylke)]
