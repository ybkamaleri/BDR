...
pre_ut <- reactive({
  ...
  if (input$valg_inspre == 1){
    ...
    ins1 = round(n / N * 100, digits = 2)
    ins10 = round(n / N * 10000, digits = 0)

    preTall = c(ins1, ins10)
...
**For barn fra 0 til 14 år i 2018**
...
renderValueBox({
  ...
  if (input$valg_inspre == 1){
    ...
    #insidens
    npop = diab_ut()[valg == 2, .N]
  }
  
  barnTxt <- paste0("Antall pasienter: ", input$valg_age[1], " - ", input$valg_age[2], " år")
