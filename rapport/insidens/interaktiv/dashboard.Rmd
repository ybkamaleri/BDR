...
norgeMapFylke <- readRDS("NorgeFylkeHF_id.Rds") #med mapID og RHF (helsereg)
...
Pr. 100 personer (%) {data-icon='fa-user'}
===================================
...
Pr. 10,000 personer {data-icon='fa-user'}
===================================
...
Informasjon {data-icon='fa-info-circle'}
===================================
...
### 
  ...
  **Data**
  ...
  - Diabetespasienter som ikke er registeret i BDR blir ikke inkludert i
    analysen. Men med 98% dekningsgrad i BDR i 2018 antar vi at de aktuelle tallene
    ikke skal vise store forskjeller med de tallene som er presentert på denne nettside.
  
  
  **Kontakt**
  
  - Ta kontakt med [BDR][bdr] for mer informasjon evt. skrev direkte på e-post <barnediabetes@ous-hf.no>
