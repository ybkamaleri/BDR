...
# write.csv(hosDT, "sykehusID.csv")
# 
# hosDT[hospID == 1 , hosKort := "Akershus"][
#   hospID == 2, hosKort := "Forde"][
#     hospID == 3, hosKort := "Haugesund"][
#       hospID == 4, hosKort := "Haukeland"][
#         hospID == 5, hosKort := "Sandessjoen"][
#           hospID == 6, hosKort := "Finnmark"][
#             hospID == 7, hosKort := "Kristiansund"][
#               hospID == 8, hosKort := "Molde"][
#                 hospID == 9, hosKort := "Namsos"][
#                   hospID == 10, hosKort := "Bodo"][
#                     hospID == 11, hosKort := "Trondheim"][
#                       hospID == 12, hosKort := "Stavanger"][
#                         hospID == 13, hosKort := "Vestfold"][
#                           hospID == 14, hosKort := "Gjovik"][
#                             hospID == 15, hosKort := "Lillehammer"][
#                               hospID == 16, hosKort := "Elverum"][
#                                 hospID == 17, hosKort := "Levanger"][
#                                   hospID == 18, hosKort := "Telemark"][
#                                     hospID == 19, hosKort := "Ostfold"][
#                                       hospID == 20, hosKort := "Arendal"][
#                                         hospID == 21, hosKort := "Kristiansand"][
#                                           hospID == 22, hosKort := "Ulleval"][
#                                             hospID == 23, hosKort := "Nord_norge"][
#                                               hospID == 24, hosKort := "Harstad"][
#                                                 hospID == 25, hosKort := "Drammen"][
#                                                   hospID == 26, hosKort := "Alesund"][]
...
dt[diaNoDiag, (diabetesVar) := mget(diabVar1), on = "Pnr"]
...
dt[dia2diag, (diabetesVar) := mget(diabVar1), on = "Pnr"]
